...
**概要**: 地域夏祭りイベントの完全企画管理システム。予算制約とリソース制約下での複雑な意思決定を含む多階層プロジェクト分解を実践し、現実的な制約条件下での再帰的問題解決を体験する。
...
**調査目的**:
- 地域住民の夏祭りに対する期待と要望の把握
- 過去のイベント参加経験と満足度の分析
- 年齢層・家族構成別の興味関心の特定
- 予算120万円での最適なコンテンツ配分の決定
